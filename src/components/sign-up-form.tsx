    ...
    return (
        <Card className="w-full max-w-md mx-auto">
            <CardHeader className="space-y-1">
                <CardTitle className="text-2xl font-bold text-center">Welcome to Fundraising!</CardTitle>
            ...
            <CardContent>
                <form action={formAction} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input className="" id="username" name="username" placeholder="johndoe" />
                        {state?.errors?.username?.length > 0 && <p className="text-xs text-red-500">{state.errors.username[0]}</p>}
                    </div>

                    <div className="space-y-2">
                        <Label htmlFor="email">Email</Label>
                        <Input id="email" name="email" type="email" placeholder="john@example.com" />
                        {state?.errors?.email?.length > 0 && <p className="text-xs text-red-500">{state.errors.email[0]}</p>}
                    </div>

                    <div className="space-y-2">
                        <Label htmlFor="password">Password</Label>
                        <Input id="password" name="password" type="password" />
                        {state?.errors?.password?.length > 0 && <p className="text-xs text-red-500">{state.errors.password[0]}</p>}
                    </div>
